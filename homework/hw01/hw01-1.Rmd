...
```{r}
print("The 30th element in the array is: ")
print(array1[30])
...
```{r}
print("The average value of the variable is 76.")
...
> The symbol ^ means "to the power of", and since there is a sequence/array/vector of the numebers from 0 to 5 - the output is 2 to the power of 0,1,2,3,4,5.
...
```{r}
print("The minimum value in the vector is: ")
min(x)
...
> The median value when we have an even number of elements is the mean of the two in the centre. So middle means the average of those two numebers.
