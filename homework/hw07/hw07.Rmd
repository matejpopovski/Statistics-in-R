...
> For 0.2 the quantile is around 2
> For 0.5 the quantile is 5
> For 0.8 the quantile is around 7
...
> The intersection between y=0.25 and the function is one single point, which gives only 1 result, while the intersection between y=0.24 and the function is multiple points which results in multiple results.
...
> The value for 0.8 will be smaller than 60.
